...
@show reward_ = my_evaluate(env, s->my_expert_policy(s))
...
plotlyjs()
episodes = Dict("Double-Q"=>double_Q_episodes, "SARSA-lambda"=>sarsa_lambda_Q_episodes, "Q-learning"=>vanilla_Q_episodes)
